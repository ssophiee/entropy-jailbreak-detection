...
#
# Usage:
#   bash approaches/ensemble_lora/scripts/summary.sh [results_dir] [summary.csv]
#
# Mode 1 – per-key dirs (default):
#   results_dir = results/ensemble_lora_trace/all_keys
#   Expects: results_dir/<key>/ensemble_trace_<key>_*.json
#
# Mode 2 – single --run_all JSON:
#   bash approaches/ensemble_lora/scripts/summary.sh path/to/ensemble_trace_all_keys_*.json

ROOT="${1:-results/ensemble_lora_trace/all_keys}"
